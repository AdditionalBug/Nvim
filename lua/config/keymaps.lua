...
---
---
--neovide keymaps load only when required
...
vim.keymap.set("n", "<leader>ff", function()
  -- Expand "~" to your Windows home (C:\Users\YourName)
  local home_dir = vim.fn.expand("~")

  -- Check which picker LazyVim 2026 is using
  if LazyVim.has("snacks.nvim") then
    -- New default in 2025/2026
    Snacks.picker.files({ cwd = home_dir })
  else
    -- Fallback for Telescope
    require("telescope.builtin").find_files({ cwd = home_dir })
  end
end, { desc = "Find Files (Windows Home)" })
